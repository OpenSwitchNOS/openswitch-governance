...
--------------------------------
This file contains the text for both the Individial Contributor Licensing
Agreement (ICLA) as well as the Coporate Contributor Licensing Agreement
...
Thank you for your interest in the OpenSwitch Project (the "Project"). In order
to clarify the intellectual property license granted with Contributions from
any person or entity, Hewlett-Packard Company as Project Manager ("Project
Manager") must have a Contributor License Agreement ("CLA") on file that has
...
protection of the Project Manager and its users; it does not change your rights
to use your own Contributions for any other purpose.
...
1. Definitions.
"You" (or "Your") shall mean the copyright owner or legal entity authorized by
the copyright owner that is making this Agreement with the Project Manager.
...
projects or products owned or managed by the Project Manager (the "Work"). For
...
irrevocable copyright license to reproduce, prepare derivative works of,
publicly display, publicly perform, sublicense, and distribute Your
Contributions and such derivativeworks.
...
waived such rights for Your Contributions to the Project Manager, or that Your
employer has executed a separate Corporate CLA with the Project Manager.
...
8. You agree to notify the Project Manager of any facts or circumstances of
